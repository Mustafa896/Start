        ...
        <div className="container">
          ...
          <div className="form w-full lg:w-3/5 mx-auto mt-16">
            <div className="name my-2">
              <label
                htmlFor="name"
                className={`block text-mainColor relative duration-500 ${topName ? "top-0 z-10" : "top-10 -z-10"
                  } `}
              >
                userName:
              </label>
            ...
            <div className="age my-2">
              <label
                htmlFor="age"
                className={`block text-mainColor relative duration-500 ${topAge ? "top-0 z-10" : "top-10 -z-10"
                  } `}
              >
                userAge:
              </label>
            ...
            <div className="mail my-2">
              <label
                htmlFor="mail"
                className={`block text-mainColor relative duration-500 ${topMail ? "top-0 z-10" : "top-10 -z-10"
                  } `}
              >
                userEmail:
              </label>
            ...
            <div className="pass my-2">
              <label
                htmlFor="pass"
                className={`block text-mainColor relative duration-500 ${topPass ? "top-0 z-10" : "top-10 -z-10"
                  } `}
              >
                userPassword:
              </label>
